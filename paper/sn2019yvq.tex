...
\begin{figure}
    ...
    for 264 SNe Ia observed by the Palomar Transient Factory (PTF) as open
    circles, with SN\,2010jn (PTF\,10ygu), the SN with the fastest moving
...
\begin{figure}
    ...
    $\lambda$5972 to \ion{Si}{II} $\lambda$6355,
    $\mathcal{R}($\ion{Si}{II}$)$, in \sn\ (large, filled circles). The
    $\mathcal{R}($\ion{Si}{II}$)$ evolution of SN\,2002bo and SN\,2011fe are
    highlighted as open diamonds and open squares, respectively. For
    comparison we also show the $\mathcal{R}($\ion{Si}{II}$)$ for 5 PTF
    SNe\,Ia (10mwb, 10qjq, 10tce, 10wof, 11hub) with $> 3$ measures over a
    duration $> 8$\,d as connected, open circles (data from
    \citealt{Maguire14}). \sn\ and SN\,2002bo exhibit an unusual inversion in
    $\mathcal{R}($\ion{Si}{II}$)$ as they evolve toward maximum light.}
    %
    \label{fig:r_evo}
\end{figure}
...
thousands of SNe\,Ia that have been cataloged in the literature, we find that
\sn\ would be considered unusual even if the early flash had been missed.
...
\approx -18.5$\,mag), relatively fast decline [$\Delta m_{15}(g) = 1.3$], and
...
observed properties of \sn\ is challenging. We find that most models either
replicate the early flash but fail to reproduce the observed behavior around
maximum light, or vice versa.
...
in the outer layers of the SN ejecta \citep[e.g.,][]{Magee20a}, the double
