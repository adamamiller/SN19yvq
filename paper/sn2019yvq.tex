...
\begin{figure*}
    ...
    modelled spectra have been smoothed with a Savitzky-Golay filter
    \citep{Savitzky64}. The photospheric velocity in the violent merger model
    is lower than what is observed in \sn, while the strength of the the IME
    absorption is weaker in the models than what is observed.}
    %
