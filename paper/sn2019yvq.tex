...
\begin{figure*}
    ...
    which a Monte Carlo packet experienced an interaction. Those packets which
    underwent only electron scattering are shown in grey, while those that did
    not interact are shown in black. \magee{I think positive contibutions are
    additive, while the ``reflected'' component is just the elements
    themselves? Can you clarify this in the caption?}}
    %
    \label{fig:tardis}
\end{figure*}
