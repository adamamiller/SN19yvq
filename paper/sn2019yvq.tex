...
\sn\ features other properties, in addition to the early maximum, that
separate it from normal SNe\,Ia. A good model should be able to explain the
following characteristics of \sn:
%
\begin{enumerate}
...
\end{enumerate}
%
\todo{Need to mention once again that 91bg is not a reasonable explanation for
this SN} Ignoring the early flash, the remaining features (2--6 in the list
above) can be understood if the explosion that gave rise to \sn\ produced a
relatively small amount of \radni\ that is strongly confined to the inner
