...
updated this a bit. The following is true of at least the first spectrum, will
check the second} While the early spectra of \sn\ are dominated by IMEs, we do
not find evidence for \ion{C}{II} absorption. Even increasing the carbon
abundance to relatively large amounts (50\%), we do not find strong
\ion{C}{II} features produced. Therefore we are unable to place meaningful
constraints on the carbon abundance in the very outermost ejecta.
