...
Table~\ref{tab:xrt}), we conclude that \sn\ is not the source of the X-rays. A
lack of X-ray emission is consistent with SNe\,Ia (e.g.,
...
\software{ \texttt{astropy} \citep{Astropy-Collaboration13}, \texttt{scipy}
\citep{2020SciPy-NMeth}, \texttt{matplotlib} \citep{Hunter07}, \texttt{pandas}
\citep{McKinney10},
