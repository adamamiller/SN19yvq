...
when fitting for the \ion{S}{II} velocities valid?} \fromkate{The \ion{S}{II} is a weak line so yes I would it expect it not to be satuarated. I don't think this lower velocity is that remarkable, the Si II 5972 and 4130 A are also always lower than the Si II 6355 A feature because they are weaker lines and their line-forming regions are located further in. I think this only matters if the modelling can't produce spectra but since they do it's probably better just to use the Si II velocity that come of it and compare directly}.
...
\fromkate{Devil's advocate on this: if the idea is that the outer layers are cooler and the photosphere recedes then there's no reason why we wouldn't see this effect in all SNe Ia since all of their velocities decrease with time? }
