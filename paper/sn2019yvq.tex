...
\begin{figure}
    \centering
    \includegraphics[width=3.35in]{./figures/dd.png}
    %
    \caption{PRELIMINARY PRELIMINARY PRELIMINARY}
    %
...
filter, the \gztf\ and \iztf\ evolution do not match what is observed.
Synthesized spectra from the double detonation models also do not match what
is observed in \sn. The model spectra are dominated by \ion{Si}{II}
