...
\title{The Spectracular Ultraviolet Flash From the \\ Type Ia Supernova 2019yvq}
...
some other non-degenerate star, the single degenerate (SD) scenairo
...
phase will narrow the range of potential explanations for this highly unsual
explosion.
...
\href{https://github.com/adamamiller/SN19yvq}{\url{https://github.com/adamami
ller/SN19yvq}}.
...
simulataneously conducts multiple time-domain surveys using the ZTF camera on
...
leading to the production and disemination of a real-time alert
...
band \citep{Benetti04}, which stands in constrast to what is observed in \sn.
