...
\enddata
\tablecomments{Phase is measured relative to \tbmax\ in the SN rest frame. Telescope abbreviations are as follows: LT -- Liverpool Telescope \citep{Steele04}, P60 -- Palomar 60-in.\ Telescope, NOT -- Nordic Optical Telescope, P200 -- Palomar 200-in.\ Hale Telescope. References for the instruments are as follows: SPRAT -- SPectrograph for the Rapid Acquisition of Transients \citep{Piascik14}, SEDM -- Spectral Energy Density machine \citep{Blagorodnova18,Rigault19}, Binospec \citep{Fabricant19}, LRIS -- Low-Resolution Imaging Spectometer \citep{Oke95}, ALFOSC -- The Andalucia Faint Object Spectrograph and Camera (\href{http://www.not.iac.es/instruments/alfosc}{\url{http://www.not.iac.es/instruments/alfosc}}), DBSP -- Double Spectrograph \citep{Oke82}.
}
\end{deluxetable}