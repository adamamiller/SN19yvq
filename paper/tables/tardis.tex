...
\colhead{Date} &
\colhead{MJD} &
\colhead{Phase\tablenotemark{{\scriptsize a}}} &
\colhead{$t - t_\mathrm{exp}$\tablenotemark{{\scriptsize b}}} &
\colhead{$L$\tablenotemark{{\scriptsize c}}} &
\colhead{$v_\mathrm{boundary}$\tablenotemark{{\scriptsize d}} }&
\colhead{$T_\mathrm{boundary}$\tablenotemark{{\scriptsize e}} } \\
\colhead{(UT) }&
\colhead{} &
\colhead{(d)} &
\colhead{(d)} &
